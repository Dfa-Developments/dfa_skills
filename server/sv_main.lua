...
lib.callback.register('dfa_skills:server:getSkills', function(source)
    local src = source
...
lib.callback.register('dfa_skills:server:updateSkill', function(source, skill, progress)
    local src = source
    local Player = RSGCore.Functions.GetPlayer(src)
...
lib.callback.register('dfa_skills:server:checkSkill', function(source, skill)
    local src = source
    local Player = RSGCore.Functions.GetPlayer(src)
...
RegisterNetEvent('dfa_skills:server:removePlayerFromCache', function()
    local src = source
    local Player = RSGCore.Functions.GetPlayer(src)
